...
<p class="meta">{created} · data: {e(analysis['source'])} · method: {e(analysis['method'])}</p>

<h2>Question</h2>
<p>Effect of <strong>{e(treatment)}</strong> on <strong>{e(outcome)}</strong>,
adjusting for <strong>{{{e(', '.join(adjustment)) or '∅'}}}</strong>
(minimal backdoor set identified from the DAG below).</p>
...
<div class="ates">
  ...
  <div class="ate adjusted"><div class="lbl">adjusted {{{e(', '.join(adjustment))}}}</div>
...
<h2>Alternative adjustment sets</h2>
